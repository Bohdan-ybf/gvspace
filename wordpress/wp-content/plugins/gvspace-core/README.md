...
- Питання задається в заголовку, відповідь — у редакторі запису.
- У блоці **Розміщення FAQ** виберіть **Головна сторінка**.
- Черговість визначається числом у полі **Атрибути → Порядок**.
- Після розгортання плагін один раз створює початкові українські й англійські записи, які можна змінювати або видаляти.

## Головна сторінка → SEO-текст

- Виділений перший рядок задається в заголовку запису.
- Основний SEO-текст редагується у стандартному редакторі.
- Для сайту використовується опублікований запис, що відповідає поточній мові.
- Після розгортання плагін один раз створює початковий український та англійський тексти.
